...
import static voting.TestUtil.readListFromJson;
...
public class TestMatcher<T> {
    ...
    public ResultMatcher contentJson(T expected) {
        return result -> assertMatch(readFromJson(result, clazz), expected);
    }

    public ResultMatcher contentJson(Iterable<T> expected) {
        return result -> assertMatch(readListFromJson(result, clazz), expected);
    }
}
